...
function TopTracksChart({ data, limit = 15 }) {
  ...
  const chartData = data.slice(0, limit).map(track => ({
  ...
  return (
    <div className="chart-container">
      <div className="chart-title">Top {limit} Tracks by Play Count</div>
